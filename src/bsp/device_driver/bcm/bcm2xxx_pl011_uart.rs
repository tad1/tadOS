...
//all of definitions shamelessly copied from: https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials/blob/master/05_drivers_gpio_uart/src/bsp/device_driver/bcm/bcm2xxx_pl011_uart.rs
register_bitfields!{
    u32,
    // Flag register
    FR[
