...
fn timer_wait_micro(delay: u64) {
    time_manager().spin_for(Duration::from_micros(delay));
}
...
impl EMMCController {
    ...
    pub fn emmc_wait_for_interrupt(&self, mask: u32) -> SdResult {
        ...
        // Data timeout occurred
        {
            ...
            // TODO: here a problem: time_diff is 0, but it's still is interrrupted!
    ...
    pub fn emmc_set_clock2(&self, freq: u32) -> SdResult {
        ...
        let control1 = self.emmc_get_clock_divider2(div)
            | ((DTO << 16) & CONTROL1::DATA_TOUNIT.val(0xf).value)
    ...
    pub fn emmc_init_card(&self) -> SdResult {
        ...
        // resp = self.emmc_set_clock2(BASE_CLOCK as u32);
        // if (resp != SdResult::EMMC_OK) {
        //     return self.emmc_debug_response(resp);
        // }
...
impl DeviceDriver for EMMCController {
    fn compatible(&self) -> &'static str {
        Self::COMPATIBLE
    }

    unsafe fn init(&self) -> Result<(), &'static str> {
        // self.inner.lock(|inner| inner.emmc_init_card());
        Ok(())
    }
}
